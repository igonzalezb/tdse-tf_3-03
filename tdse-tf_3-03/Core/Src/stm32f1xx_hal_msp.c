...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = PWM_Bomba_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(PWM_Bomba_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PC9     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = PWM_LED_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(PWM_LED_B_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PB9     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = PWM_LED_G_Pin|PWM_LED_R_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
