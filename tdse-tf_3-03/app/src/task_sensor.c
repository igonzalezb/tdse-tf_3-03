...
// ENTER
		{ ID_BTN_ENT, BTN_ENT_PORT, BTN_ENT_PIN, BTN_ENT_PRESSED,
				DEL_BTN_XX_MAX, DEL_BTN_XX_HOLD, EV_SYS_NONE, EV_SYS_BTN_ENTER,
				EV_SYS_NONE },
		// NEXT (DERECHA)
		{ ID_BTN_NEX, BTN_NEX_PORT, BTN_NEX_PIN, BTN_NEX_PRESSED,
				DEL_BTN_XX_MAX, DEL_BTN_XX_HOLD, EV_SYS_NONE, EV_SYS_BTN_RIGHT,
				EV_SYS_NONE },
		// PREV (IZQUIERDA)
		{ ID_BTN_PREV, BTN_PREV_PORT, BTN_PREV_PIN, BTN_PREV_PRESSED,
				DEL_BTN_XX_MAX, DEL_BTN_XX_HOLD, EV_SYS_NONE, EV_SYS_BTN_LEFT,
				EV_SYS_NONE },
		// ESC
		{ ID_BTN_ESC, BTN_ESC_PORT, BTN_ESC_PIN, BTN_ESC_PRESSED,
				DEL_BTN_XX_MAX, DEL_BTN_XX_HOLD, EV_SYS_NONE, EV_SYS_BTN_ESC,
				EV_SYS_BTN_ESC_HOLD } };
			...
			if (EV_BTN_XX_DOWN == p_task_sensor_dta->event) {
				if (DEL_BTN_XX_MIN == p_task_sensor_dta->tick) {
					...
					p_task_sensor_dta->tick_hold =
							p_task_sensor_cfg->tick_hold_max;
				} else {
					p_task_sensor_dta->tick--;
				}
			}
